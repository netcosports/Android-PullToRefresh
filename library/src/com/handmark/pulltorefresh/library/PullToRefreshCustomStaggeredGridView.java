...
import com.netcosports.utils.CustomStaggeredGridView;
import com.netcosports.utils.StaggeredGridView;
import com.netcosports.utils.StaggeredGridView.OnScrollListener;

public class PullToRefreshCustomStaggeredGridView extends PullToRefreshBase<CustomStaggeredGridView> implements OnScrollListener{

	public PullToRefreshCustomStaggeredGridView(Context context) {
		super(context);
		mRefreshableView.setOnScrollListener(this);
	}
	
	public PullToRefreshCustomStaggeredGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshCustomStaggeredGridView(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshCustomStaggeredGridView(Context context, Mode mode, AnimationStyle style) {
	...
	@Override
	protected final CustomStaggeredGridView createRefreshableView(Context context, AttributeSet attrs) {
		final CustomStaggeredGridView gv;
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			gv = new InternalCustomStaggeredGridViewSDK9(context, attrs);
		} else {
			gv = new InternalCustomStaggeredGridView(context, attrs);
		}
	...
	class InternalCustomStaggeredGridView extends CustomStaggeredGridView implements EmptyViewMethodAccessor {

		public InternalCustomStaggeredGridView(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
...
//			super.setEmptyView(emptyView);
	...
	@TargetApi(9)
	final class InternalCustomStaggeredGridViewSDK9 extends InternalCustomStaggeredGridView {

		public InternalCustomStaggeredGridViewSDK9(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshCustomStaggeredGridView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
...
//	}
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			final int lastVisiblePosition = mRefreshableView.getFirstPosition() + mRefreshableView.getChildCount();
