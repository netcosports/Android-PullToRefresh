...
public final class PullToRefreshStaggeredGridActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPullRefreshGridView = (PullToRefreshStaggeredGridView) findViewById(R.id.pull_refresh_grid);
		mGridView = mPullRefreshGridView.getRefreshableView();

		// Set a listener to be invoked when the list should be refreshed.
		mPullRefreshGridView.setOnRefreshListener(new OnRefreshListener2<StaggeredGridView>() {
